...
static float orange2= 0;
static float orange3= 0;
static float orange4= 0;
static float orange5= 0;
static float orange6= 0;
...
void my_keyboard(unsigned char key, int x, int y)
{
    ...
    case 'd':
        ...
        glutIdleFunc(dayMode);
        break;

    case 'a':
        glutDisplayFunc(rainyModeNight);
        glutIdleFunc(rainyModeNight);
        break;
